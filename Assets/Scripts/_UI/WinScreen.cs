...
public class WinScreen : Dialog {
    ...
    protected override IEnumerator PlayShowAnim(Action onShowFinished = null) {
...
//        yield return new WaitUntil(() => _isContinueClicked);
    ...
    */
    ...
    protected override IEnumerator HideAnim(Action onCompleted) {
        var moveAwayDur = 0.5f;
        energyTr.DOKill();

        gameUI.MoveEnergy(_addedScore, energyTr.position, moveAwayDur);
        energyTr.anchoredPosition = energyOriginPos;
